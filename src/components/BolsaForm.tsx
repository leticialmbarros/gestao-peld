      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select name="bolsa" required value={formData.bolsa} onChange={(e) => { handleChange(e); setFormData((prev: any) => ({ ...prev, subcategoria: '' })); }} className="w-full p-2 border rounded-md focus:ring-indigo-500 focus:border-indigo-500">
              <option value="">Selecione...</option>
