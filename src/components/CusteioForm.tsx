      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select name="grupo" required value={formData.grupo} onChange={(e) => { handleChange(e); setFormData((prev: any) => ({ ...prev, subgrupo: '' })); }} className="w-full p-2 border rounded-md focus:ring-emerald-500 focus:border-emerald-500">
              <option value="">Selecione...</option>
          ...
          <div>
            ...
            <select name="rubrica" required value={formData.rubrica} onChange={(e) => { handleChange(e); setFormData((prev: any) => ({ ...prev, subcategoria: '' })); }} className="w-full p-2 border rounded-md focus:ring-emerald-500 focus:border-emerald-500">
              <option value="">Selecione...</option>
